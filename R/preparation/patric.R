...
#Check if you need to do it on genome_name or organism_name (odd column header)
...
# If we remove genome_size from below criteria, the data frame is reduced to ~15,000 rows... 
